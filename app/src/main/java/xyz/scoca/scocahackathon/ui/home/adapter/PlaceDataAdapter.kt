    ...
    inner class ViewHolder(private val itemBinding : ItemPlaceBinding) : RecyclerView.ViewHolder(itemBinding.root) {
        fun bind(){
            ...
            itemBinding.btnDetail.setOnClickListener {
                itemBinding.btnDetail.setImageResource(R.drawable.heart_filled)
